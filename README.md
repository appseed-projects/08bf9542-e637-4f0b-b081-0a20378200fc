...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-23 17:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/08bf9542-e637-4f0b-b081-0a20378200fc.git
$ cd 08bf9542-e637-4f0b-b081-0a20378200fc
```
